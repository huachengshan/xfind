...
$(function(){
	...
	var educationExpList = {
		...
		loadData:function(){
			//执行ajax请求
			var url = serverUrl + "/trainingExperiences/getDataByUserId/" + user.id;
		...
		editExp:function(){
			$(document).on("click", ".myFocus", function(){
				...
				wx_navigate("/pages/redirect/redirect?url="+escape("skillExp.html?id=" + code));
			})
		},
		addExp:function(){
			$("#addExp-btn").on("click", function(){
				wx_navigate("/pages/redirect/redirect?url=skillExp.html");
			});
		}
	}
