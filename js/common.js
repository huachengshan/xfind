document.write("<script type=\"text/javascript\" src=\"js/fit.js\"></script>");
...
var imageUrl = "https://xfindcdn.qitenai.com";
...
$(function(){
    ...
    var utils = {
        post : function(url, params, func, error) {
            $.ajax({
                type : "post",
                dataType : "json",
                url : url,
        ...
        request : function(url, params, func, error) {
            $.ajax({
                type : "post",
                dataType : "json",
                url : url,
        ...
        get:function(url, params, func, error){
            $.ajax({
                type : "get",
                dataType : "json",
                url : url,
        ...
        upload:function(url, params, func, error){
            $.ajax({  
                url: url,  
                type: 'POST',  
                cache: false,  
        ...
        delete:function(url, params, func, error){
            $.ajax({
                type : "delete",
                dataType : "json",
                url : url,
...
function getDateStr(date) {
    ...
    var dateStr = date.getFullYear() + "." + monthStr  + "." + (date.getDate()<10?"0"+date.getDate():date.getDate());
    return dateStr;
}
